...
public class Bme280 implements AutoCloseable {
    ...
    private static final String TAG = com.google.android.things.contrib.driver.bmx280.Bmx280.class.getSimpleName();
     ...
     * @throws IOException
     */
    public void setMode(@com.google.android.things.contrib.driver.bmx280.Bmx280.Mode int mode) throws IOException {
        if (mDevice == null) {
     ...
     * @throws IOException
     */
    public void setTemperatureOversampling(@com.google.android.things.contrib.driver.bmx280.Bmx280.Oversampling int oversampling) throws IOException {
        if (mDevice == null) {
            throw new IllegalStateException("I2C device not open");
        }
     ...
     * @throws IOException
     */
    public void setPressureOversampling(@com.google.android.things.contrib.driver.bmx280.Bmx280.Oversampling int oversampling) throws IOException {
        if (mDevice == null) {
            throw new IllegalStateException("I2C device not open");
        }
